export const Paths = [
  {
    id: 1,
    name: "Starting to find more about Web Development and being attracted to Frontend",
    date: "Jun, 2020",
    imgSrc:
  ...
  {
    id: 2,
    name: "Begin to learn HTML and CSS",
  ...
  {
    id: 3,
    name: "Finding and learning about JavaScript",
  ...
  {
    id: 4,
    name: "Getting into UX/UI design",
